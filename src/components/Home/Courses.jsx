...
const navigate = useNavigate()
  ...
  return (
    <section className="py-12 px-24 max-w-7xl mx-auto relative">
      
      {/* Top Heading */}
      <div className="text-center mb-6">
        
      <h2 className="text-4xl font-bold mt-2">
          <span className="text-indigo-900">Bachelor Courses</span>
        </h2>
      </div>
          ...
          <div key={index} className="relative group">
            ...
            <div className="absolute -bottom-14 left-0 right-0 flex justify-end">
              <div className="bg-white rounded-bl-sm rounded-br-sm rounded-tl-sm shadow-md px-6 py-4 w-[88%] flex justify-between items-center">
                ...
                <button onClick={() =>{navigate(`/${card.title}`); scrollTo(0,0)}} className="w-10 h-10 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center cursor-pointer">
                  <ArrowRight size={20} />
                </button>
