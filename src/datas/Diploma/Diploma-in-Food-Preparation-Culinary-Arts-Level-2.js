const courseData = {
    frontImage: "/image/Diploma/front.webp",
    title: "Diploma in Food Preparation & Culinary Arts - Level 2 ",
    overview:
      "The Level 2 Diploma in Food Preparation and Culinary Arts is designed for individuals seeking to begin or advance their careers in the hospitality industry. This program is designed for candidates seeking a career in hospitality with prior knowledge of kitchen fundamentals or a strong commitment to learning. Candidates must demonstrate practical skills and knowledge to complete assessments.\n\nThis qualification aligns with the Global Hospitality Certification, a global industry standard developed with World Chefs and employers. It covers both transferable and job-specific skills, emphasizing sustainability. Notably, it includes digital badges for online qualification display. These global qualifications prepare City & Guilds graduates for successful hospitality careers, incorporating the latest industry trends and safety, food preparation, healthy eating, special diets, cost management, menu planning, and culinary ski lls.\n\nAs an added bonus, you will receive a 407 Training Visa for Australia. Moreover, our students also get the chance to explore international internships in renowned locations like UAE- Dubai, Abu Dhabi, Qatar, Bahrain, Saudi Arabia, Kuwait, Oman and other Middle Eastern countries famous for their luxurious 5-star hotels and resorts.",
    additionalDetails: [
    ...
    aboutImages: [
      "/image/Diploma/image5.webp",
      "/image/Diploma/image6.webp",
      "/image/Diploma/image7.webp",
      "/image/Diploma/image8.webp",
    ],
    aboutContent: {
    ...
    faqs: [
      {
        ...
        answer:
          "This program is tailored for individuals who have successfully completed 12th grade or higher. Fluency in English, both spoken and written, is also a prerequisite for applicants.",
      },
      {
