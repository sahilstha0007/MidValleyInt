const courseData = {
  frontImage: "/image/Diploma/front5.webp",
  title: "Diploma in Professional Patisserie and Confectionary - Level 3",
  overview:
    "Diploma in Professional Patisserie and Confectionary – Level 3 is tailored for individuals aspiring to become or currently working as patisserie chefs in the catering and hospitality sector. It equips learners with specialized skills and knowledge essential for excelling in the world of pastry and dessert preparation, positioning them for success in this culinary field.\n\n This qualification is a comprehensive program that enables candidates to acquire, refine, and apply essential skills required for success and career advancement in the catering and hospitality sector. It offers practical learning and hands-on experience, ensuring candidates are well-prepared for employment and career growth in this dynamic industry.\n\n Moreover, you will receive a 407 Training Visa for Australia. Additionally, our students also get the chance to explore international internships in renowned locations like UAE- Dubai, Abu Dhabi, Qatar, Bahrain, Saudi Arabia, Kuwait, Oman, and other Middle Eastern countries famous for their luxurious 5-star hotels, and resorts.",
  additionalDetails: [
    "Training in modern patisserie trends and innovative dessert design concepts.",
    "Cost control, inventory management, and food safety protocols specific to pastry production.",
    "Sweet photography and food styling for social media and professional portfolios.",
    "Access to international culinary festivals and industry exhibitions for networking."
  ],
  aboutImages: [
  ...
  programOverview: {
    ...
    description:
      "Diploma in Professional Patisserie and Confectionary – Level 3 is an intensive program designed to provide aspiring pastry chefs and confectioners with the essential skills and knowledge required to excel in the world of pastry arts. This comprehensive course combines theory and practical training to develop expertise in the creation of exquisite pastries, desserts, and confections.",
    requirements: [
      { label: "Required Educational Qualification", value: "At least 16 years old, Level 2 qualification or relevant industry experience recommended" },
  ...
  careerPathways: {
    description: [
      "Our Diploma in Professional Patisserie and Confectionary- Level 3 not only equips you with the necessary skills and knowledge but also prepares you for a successful and fulfilling career.",
  ...
  faqs: [
    {
      ...
      answer:
        "This program is ideally suited for individuals who are at least 16 years old or above. It is highly recommended for learners who have either completed a formal Level 2 qualification or possess relevant industry experience.",
    },
    {
      question: "What does the post-degree certificate consist of?",
      answer:
        "The post-degree certificate in the Level 3 Diploma in Professional Patisserie and Confectionery – 7120 – 33 course offers advanced training in pastry and confectionery arts. The curriculum focuses on honing skills like chocolate work and sugar work, while also covering menu planning, food safety, hygiene, and business management. Graduates can pursue careers as pastry chefs, confectioners, cake decorators, bakery managers, product development specialists, food stylists, or culinary educators in various industry settings.",
    },
    {
