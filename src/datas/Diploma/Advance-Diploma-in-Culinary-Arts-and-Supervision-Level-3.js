...
const courseData = {
  ...
  overview:
    "The Level 3 Advanced Diploma in Culinary Arts and Supervision is designed for experienced chefs looking to expand their knowledge in kitchen operations, staff management, and the broader hospitality industry.Candidates must showcase their supervisory skills through assessments, including both theoretical and practical aspects.\n\n This qualification aligns with the Global Hospitality Certification, a global industry standard developed with World Chefs and employers.It covers transferable and job - specific skills, emphasizing sustainability and offering digital badges for online recognition.Graduates are well - prepared for successful hospitality careers, equipped with the latest industry trends and technology.It also includes food safety supervision, menu planning, global influences, and resource management training.\n\n Moreover, you will receive a 407 Training Visa for Australia.Additionally, our students also get the chance to explore international internships in renowned locations like UAE - Dubai, Abu Dhabi, Qatar, Bahrain, Saudi Arabia, Kuwait, Oman, and other Middle Eastern countries famous for their luxurious 5 - star hotels and resorts.",
  additionalDetails: [
    "Advanced training in culinary research and development for menu innovation.",
    "Cross-cultural kitchen management and team leadership in diverse settings.",
    "Personalized career development planning for hospitality leadership roles.",
    "Exclusive mentorship programs with industry leaders and potential job placements.",
  ],
  aboutImages: [
    "/image/Diploma/image10.webp",
    "/image/Diploma/image6.webp",
    "/image/Diploma/image11.webp",
    "/image/Diploma/image12.webp",
  ],
  aboutContent: {
  ...
  programOverview: {
    ...
    description:
      "TAdvance Diploma in Culinary Arts and Supervision – Level 3 is a comprehensive program designed to develop aspiring culinary professionals into skilled chefs with the ability to lead and supervise kitchen operations. This course combines practical culinary training with managerial and supervisory skills, providing students with a well-rounded education in the culinary arts industry.",
    requirements: [
      { label: "Required Educational Qualification", value: "Grade 10 passed and above" },
      { label: "Total Course Duration", value: "6 Months" },
      { label: "Total Qualification Hours", value: "1284 Hours" },
  ...
  careerPathways: {
    description: [
      "By completing this course, you’ll become job ready, equipped with the skills and knowledge needed to excel in various culinary roles. Additionally, we provide internships to further enhance your practical experience.",
      "Moreover, we also provide job placement assistance opportunities in Australia, the United Kingdom (UK), the United Arab Emirates (UAE), and other Middle Eastern countries to help you find suitable employment opportunities in the industry. In addition, you will also be provided 407 Training Visa for Australia.",
    ],
    image: "/image/Diploma/Diploma407-VISA-to-Australia-_-MVIC.webp",
    companyImages: [
  ...
  faqs: [
    {
      ...
      answer:
        "Advance Diploma in Culinary Arts and Supervision – Level 3 is ideal for individuals aged 16 or above. Prior completion of a Level 2 qualification or equivalent industry experience is strongly advised.",
    },
    {
      question: "What does the post-degree certificate consist of?",
      answer:
        "The post-degree certificate in the Advance Diploma in Culinary Arts and Supervision – Level 3 course provides experienced chefs with advanced knowledge and skills in kitchen operations, staff management, strategic planning, menu development, financial management, leadership, and team supervision. Candidates will develop expertise in running a successful kitchen, enhancing culinary techniques, and mastering effective leadership. They will also gain insights into menu planning, financial management, and food safety regulations. Graduates will be well-prepared for supervisory roles and contribute to the success of culinary establishments.",
    },
    {
