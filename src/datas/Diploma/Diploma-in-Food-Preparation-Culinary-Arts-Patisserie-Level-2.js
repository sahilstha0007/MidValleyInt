...
const courseData = {
  ...
  overview:
    "Diploma in Food Preparation & Culinary Arts (Patisserie) Level 2 is perfect for those aiming to start or enhance their careers in the hospitality industry. It covers both transferable and job-specific skills defined by employers, ensuring candidates are not only job-ready for specific roles but also for broader hospitality careers. Assessments require demonstrating practical skills and associated knowledge, providing a comprehensive learning experience. \n\n This qualification provides candidates with the opportunity to acquire, enhance, and apply the essential skills necessary for gaining employment or advancing their careers within the catering and hospitality sector. Through this program, individuals can actively learn, hone, and put into practice the competencies and knowledge required to excel in this industry. This encompasses a range of skills, from culinary techniques and food safety to customer service and menu planning, empowering candidates to thrive in various roles and scenarios within the field. \n\n Moreover, you will receive a 407 Training Visa for Australia. Additionally, our students also get the chance to explore international internships in renowned locations like UAE- Dubai, Abu Dhabi, Qatar, Bahrain, Saudi Arabia, Kuwait, Oman, and other Middle Eastern countries famous for their luxurious 5-star hotels and resorts.",
  additionalDetails: [
    "Practical, real-world experience guided by seasoned culinary professionals.",
    "Train in fully equipped, modern kitchens designed to meet global standards.",
    "Showcase your talent in national and international culinary contests.",
    "Earn a globally respected certification from City & Guilds, opening doors worldwide.",
  ],
  aboutImages: [
    "/image/Diploma/churros-mvic.webp",
    "/image/Diploma/belgium-waffles-mvic.webp",
    "/image/Diploma/matcha-cake-mvic.webp",
    "/image/Diploma/macarons-_-mvic.webp",
  ],
  aboutContent: {
  ...
  programOverview: {
    ...
    requirements: [
      ...
      { label: "Total Qualification Hours", value: "609 Hours" },
  ...
  careerPathways: {
    description: [
      "Diploma in Food Preparation & Culinary Arts (Patisserie) Level 2 not only equips you with the necessary skills and knowledge but also prepares you for a successful and fulfilling career.",
  ...
  faqs: [
    {
      ...
      answer:
        "Diploma in Food Preparation & Culinary Arts – Level 2 is open to aspiring individuals aged 16 years and above, who are passionate about pursuing a career in the culinary arts. No prior experience is required, your enthusiasm and eagerness are only necessary.",
    },
    {
      question: "What does the post-degree certificate consist of?",
      answer:
        "The post-degree certificate can refer to additional courses or training programs that build upon the foundational knowledge and skills gained during the diploma program. These additional courses could focus on advanced culinary techniques, specialized cuisines, kitchen management, or other related topics to further enhance and expand the culinary expertise of individuals who have already completed the diploma program.",
    },
    {
  ...
  relatedCourses: [
    { title: "Advanced Diploma in Culinary Arts and Supervision – Level 3", duration: "12 Months", image: "/image/Diploma/cng-culinary.webp" },
    { title: "Diploma in Professional Patisserie and Confectionary – Level 3", image: "/image/Diploma/image2.webp" },
    { title: "Diploma in Professional Patisserie and Confectionary – Level 3", image: "/image/Diploma/cng-patisserie.webp" },
  ],
};
