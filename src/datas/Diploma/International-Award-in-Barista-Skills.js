const courseData = {
  frontImage: "/image/Diploma/front6.webp",
  title: "International Award in Barista Skills  ",
  overview:
    "This comprehensive course will teach you the essential skills and techniques needed to create exceptional coffee.From learning how to extract the perfect flavors to mastering the art of brewing and milk techniques, you’ll become a coffee- making expert.\n\n Our program teaches you how to be a skilled barista or coffee expert.You will learn by doing, with hands - on practice and tests.But it’s not just about making coffee – you will discover the cool stories, culture, and what is popular in the world of coffee.Once you are done, you will be ready to work in coffee shops, special cafes, or you can even start your own coffee business.",
  additionalDetails: [
    "Hands-on training with industry experts.",
    "Access to state-of-the-art kitchen facilities.",
    "Opportunities to participate in culinary competitions.",
    "Internationally recognized certification by City & Guilds.",
  ],
  aboutImages: [
    "/image/Diploma/coffee-art.webp",
    "/image/Diploma/Coffee-pouring-_barista.webp",
    "/image/Diploma/handpress-coffee.webp",
    "/image/Diploma/coffee-beans.webp",
  ],
  aboutContent: {
  ...
  programOverview: {
    ...
    description:
      "The International Award in Barista Skills is a comprehensive course designed to equip participants with the essential knowledge and practical skills needed to excel as a professional barista. Whether you’re a coffee enthusiast looking to enhance your expertise or an aspiring barista seeking a solid foundation, this course is tailored to meet your needs.",
    requirements: [
      { label: "Required Educational Qualification", value: "SEE passed or aged 16 and above" },
      { label: "Total Course Duration", value: "7 - 14 Days with Internship Assistance" },
      { label: "Total Qualification Hours", value: "30 - 45 Hours" },
  ...
  careerPathways: {
    description: [
      "After completing our barista course, you will have a world of career opportunities brewing for you. You can start as a barista at your favorite coffee shop, crafting exquisite brews. Or, you can take your skills to the next level by exploring coffee roasting, where you will master the art of creating unique coffee flavors.",
      "Moreover, if you are into starting your own business, you might even open your own cafe and share your passion with the world. There are lots of opportunities in the coffee world, and with your barista certification, you are all set for an exciting career..",
    ],
  ...
  faqs: [
    {
      ...
      answer:
        "This program welcomes individuals who are 16 years or older or have completed their SEE. These prerequisites guarantee that students possess the necessary maturity and educational background to actively participate and derive maximum value from the course.",
    },
    {
      question: "What does the post-degree certificate consist of?",
      answer:
        "The post-degree certificate in the International Award in Barista Skills course offers a comprehensive curriculum covering coffee history, bean varieties, flavor profiles, equipment usage, espresso extraction techniques, milk frothing, latte art, customer service, and communication skills. Upon completion, students will be skilled baristas capable of creating exceptional coffee, meeting customer needs, and thriving in the coffee industry.",
    },
    {
